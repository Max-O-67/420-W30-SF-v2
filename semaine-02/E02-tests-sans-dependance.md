...
[solution fournie](./S02E02E04_Restaurant_Commande/) et exécutez `dotnet test`
...
git add .
git status
git commit -m "E02 - Ajoute les tests sans dépendance"
git push
```

Passez ensuite à [E03 — Simulacre manuel](./E03-simulacre-manuel.md).
