...
`S02E02E04_Restaurant_Commande.Tests`, puis lisez
`ServiceFinalisationCommande.cs` avant de configurer un mock.

```bash
dotnet add S02E02E04_Restaurant_Commande.Tests/S02E02E04_Restaurant_Commande.Tests.csproj package Moq
dotnet restore
```
...
Dans E03, deux classes de simulacres manuels étaient nécessaires pour exprimer
...
git add .
git status
git commit -m "E04 - Teste la finalisation de commande avec Moq"
git push
```
