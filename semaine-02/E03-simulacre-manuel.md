...
Créez deux classes dans `S02E02E04_Restaurant_Commande.Tests`, sans utiliser
Moq.
...
git add .
git status
git commit -m "E03 - Ajoute le simulacre manuel de cuisine"
git push
```

Passez ensuite à [E04 — Moq](./E04-moq.md).
