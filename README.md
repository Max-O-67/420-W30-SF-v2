# Organisation du cours de programmation orientée objet II

## Notes de cours

Les présentations utilisées en classe sont disponibles sur la plateforme
d'enseignement. Elles proposent des explications synthétiques et des exemples
de code pour chaque sujet abordé.
...
Ce dépôt Git contient les exercices du cours. Chaque exercice se trouve dans un
sous-dossier et comporte un fichier `README.md` qui décrit le travail à
réaliser. Les exercices sont regroupés par semaine, soit par bloc de 5 heures.

La liste des travaux à remettre se trouve dans le fichier
...
Dans ce cours, Git sert à gérer les versions des exercices et des projets.
Utilisez l'interface en ligne de commande afin de bien comprendre les concepts
et les opérations de Git.

Les notions de base sont présentées en classe et expliquées plus en détail dans
les notes de cours.
